...
# Ruta base donde tienes los zips de Exercicios
DIR_ZIPS="/media/jcscmint/HD RESPALDO JC1GB/Compartida DWCC/Exercicios"
TEMP_DIR="temp_unzip"
...
for zipfile in "$DIR_ZIPS"/*.zip; do
    if [ -f "$zipfile" ]; then
        ...
        NOMBRE_RAMA="Exercicios-$NOMBRE_ZIP"
        ...
        git add .
        git commit -m "Automático: Añadido ejercicio comprimido $NOMBRE_RAMA"
...
echo "¡Todos los ejercicios comprimidos han sido subidos a sus respectivas ramas!"