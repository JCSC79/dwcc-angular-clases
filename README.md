...
Aplicación matemática Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| Lógica | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | Calculator | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=calculator+en+español)
