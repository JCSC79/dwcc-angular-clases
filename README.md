# 📘 Repaso-Repaso-Comunicacion-Componhentes - Repaso: Comunicación

## 🎯 Objetivo del Ejercicio

Consolidar @Input/@Output
...
### Concepto Principal
Este ejercicio enseña los fundamentos y buenas prácticas de repaso: comunicación.
...
```bash
# 1. Cambiar a la rama
git checkout Repaso-Repaso-Comunicacion-Componhentes
...
Continúa con **Repaso-Repaso-Directivas** para profundizar en los conceptos.

---

**¡Felicidades!** 🎉 Ya entiendes repaso: comunicación, un concepto clave en Angular.
