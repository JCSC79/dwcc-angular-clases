# 📘 Exercicios-Exercicio-Peliculas-Rutas - Ejercicio Especial: Películas y Rutas

## 🎯 Objetivo del Ejercicio

Aplicación de películas con routing y CRUD

**Tema**: Crearás aplicación completa de películas
...
### 1. **Películas**
Concepto fundamental para entender ejercicio especial: películas y rutas.
...
```bash
# 1. Ir a la rama
git checkout Exercicios-Exercicio-Peliculas-Rutas
...
Continúa con **Exercicios-ExercicioPortaLuz - Ejercicio Especial: Porta da Luz**

---

**¡Felicidades!** 🎉 Ya entiendes ejercicio especial: películas y rutas, un concepto clave en Angular.
