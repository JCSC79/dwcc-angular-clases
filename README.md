# 📘 T06E14-rutas-parametros-consulta - Query Parameters

## 🎯 Objetivo del Ejercicio

Parámetros de consulta (?param)
...
### Concepto Principal
Este ejercicio enseña los fundamentos y buenas prácticas de query parameters.
...
```bash
# 1. Cambiar a la rama
git checkout T06E14-rutas-parametros-consulta
...
Continúa con **T06E15-rutas-guards** para profundizar en los conceptos.

---

**¡Felicidades!** 🎉 Ya entiendes query parameters, un concepto clave en Angular.
