...
Cargar componentes dinámicamente Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| [ngComponentOutlet] | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | NgComponentOutlet | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=ngcomponentoutlet+en+español)
