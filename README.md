...
Estilos dinámicos en bucles Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| *ngFor con [ngClass] | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | NgFor + NgClass | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=ngfor+++ngclass+en+español)
