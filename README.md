# 📘 T06E21-crud-cliente-servidor - CRUD Completo

## 🎯 Objetivo del Ejercicio

Implementar Create, Read, Update, Delete con servidor

**Tema**: Implementaras operaciones CRUD completas
...
### 1. **CRUD**
Concepto fundamental para entender crud completo.
...
```bash
# 1. Ir a la rama
git checkout T06E21-crud-cliente-servidor
...
Continúa con **T06E22-ficheiro-JSON - Cargar JSON desde Archivo**

---

**¡Felicidades!** 🎉 Ya entiendes crud completo, un concepto clave en Angular.
