# 📘 T06E32-probas-unitarias - Pruebas Unitarias
...
### Concepto Principal
Este ejercicio enseña los fundamentos y buenas prácticas de pruebas unitarias.
...
```bash
# 1. Cambiar a la rama
git checkout T06E32-probas-unitarias
...
Continúa con **T06E33-probas-crud** para profundizar en los conceptos.

---

**¡Felicidades!** 🎉 Ya entiendes pruebas unitarias, un concepto clave en Angular.
