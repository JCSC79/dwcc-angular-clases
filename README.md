...
Alternativa a múltiples *ngIf Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| *ngSwitch | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | NgSwitch | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=ngswitch+en+español)
