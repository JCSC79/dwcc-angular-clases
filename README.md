# 📘 T06E23-WebStorage - LocalStorage y SessionStorage

## 🎯 Objetivo del Ejercicio

Guardar y recuperar datos del navegador usando Web Storage

**Tema**: Guardaras datos en el navegador persistentemente
...
### 1. **localStorage**
Concepto fundamental para entender localstorage y sessionstorage.
...
```bash
# 1. Ir a la rama
git checkout T06E23-WebStorage
...
Continúa con **T06E24-control-a-medida - Controles Personalizados**

---

**¡Felicidades!** 🎉 Ya entiendes localstorage y sessionstorage, un concepto clave en Angular.
