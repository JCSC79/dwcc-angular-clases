# 📘 T06E17-formularios-reactivos-validacion - Validación de Formularios

## 🎯 Objetivo del Ejercicio

Validar formularios con validadores built-in y personalizados

**Tema**: Validaras datos de formularios profesionalmente
...
### 1. **Validators**
Concepto fundamental para entender validación de formularios.
...
```bash
# 1. Ir a la rama
git checkout T06E17-formularios-reactivos-validacion
...
Continúa con **T06E18-formularios-reactivos-bulma - Formularios con CSS (Bulma)**

---

**¡Felicidades!** 🎉 Ya entiendes validación de formularios, un concepto clave en Angular.
