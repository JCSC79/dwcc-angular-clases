# 📘 Exercicios-ExercicioPortaLuz - Ejercicio Especial: Porta da Luz

## 🎯 Objetivo del Ejercicio

Aplicación interactiva especializada

**Tema**: Crearás aplicación interactiva especializada
...
### 1. **Aplicación**
Concepto fundamental para entender ejercicio especial: porta da luz.
...
```bash
# 1. Ir a la rama
git checkout Exercicios-ExercicioPortaLuz
...
Continúa con **Exercicios-ExercicioTaboa - Ejercicio Especial: Taboa**

---

**¡Felicidades!** 🎉 Ya entiendes ejercicio especial: porta da luz, un concepto clave en Angular.
