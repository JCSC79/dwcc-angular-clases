# 🎯 COMBINACIÓN NGSWITCH + NGSTYLE

## ¿Qué se usa?

Este ejercicio enseña:
- ***ngSwitch con [ngStyle]**
- **Aplicación práctica**
- Patrones y mejores prácticas

## ❓ ¿Por qué se usa?

Estilos dinámicos con condicionales Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| *ngSwitch con [ngSty | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | NgSwitch + NgStyle | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=ngswitch+++ngstyle+en+español)
