...
Proteger acceso a rutas Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| CanActivate | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | Route Guards | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=route+guards+en+español)
