...
Optimizar iteraciones Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| *ngFor con index | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | NgFor v2 | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=ngfor+v2+en+español)
