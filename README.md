...
Aislar estilos por componente Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| styles | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | Component Styles | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=component+styles+en+español)
