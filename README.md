# 📘 T06E12-rutas-aninhadas - Rutas Anidadas

## 🎯 Objetivo del Ejercicio

Crear rutas jerárquicas y nested router-outlets

**Tema**: Estructuraras rutas complejas jerárquicamente
...
### 1. **Rutas anidadas**
Concepto fundamental para entender rutas anidadas.
...
```bash
# 1. Ir a la rama
git checkout T06E12-rutas-aninhadas
...
Continúa con **T06E13-rutas-parametros - Parámetros en Rutas**

---

**¡Felicidades!** 🎉 Ya entiendes rutas anidadas, un concepto clave en Angular.
