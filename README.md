...
Reutilizar bloques HTML Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| <ng-template> | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | NgTemplate | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=ngtemplate+en+español)
