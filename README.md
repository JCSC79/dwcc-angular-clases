# 📘 Exercicios-TaboaOrdenable - Ejercicio Especial: Taboa Ordenable

## 🎯 Objetivo del Ejercicio

Tabla con capacidad de ordenamiento

**Tema**: Crearás tablas ordenables dinámicamente
...
### 1. **Tabla**
Concepto fundamental para entender ejercicio especial: taboa ordenable.
...
```bash
# 1. Ir a la rama
git checkout Exercicios-TaboaOrdenable
...
Continúa con **Exercicios-XanelasModais - Ejercicio Especial: Diálogos Modales**

---

**¡Felicidades!** 🎉 Ya entiendes ejercicio especial: taboa ordenable, un concepto clave en Angular.
