...
Control dinámico de estilos Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| [ngClass] | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | NgClass + NgStyle | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=ngclass+++ngstyle+en+español)
