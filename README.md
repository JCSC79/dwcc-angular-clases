...
Manipular requests/responses Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| HttpInterceptor | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | Interceptors | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=interceptors+en+español)
