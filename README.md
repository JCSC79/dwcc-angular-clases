# 📘 T06E16-formularios-reactivos - Formularios Reactivos

## 🎯 Objetivo del Ejercicio

Crear formularios usando FormBuilder y FormControl

**Tema**: Controlaras formularios de forma reactiva
...
### 1. **FormBuilder**
Concepto fundamental para entender formularios reactivos.
...
```bash
# 1. Ir a la rama
git checkout T06E16-formularios-reactivos
...
Continúa con **T06E17-formularios-reactivos-validacion - Validación de Formularios**

---

**¡Felicidades!** 🎉 Ya entiendes formularios reactivos, un concepto clave en Angular.
