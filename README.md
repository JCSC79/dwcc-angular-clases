# 📘 Repaso-RepasoGuard - Repaso: Guards
...
### Concepto Principal
Este ejercicio enseña los fundamentos y buenas prácticas de repaso: guards.
...
```bash
# 1. Cambiar a la rama
git checkout Repaso-RepasoGuard
...
Continúa con **Repaso-Repaso-Input** para profundizar en los conceptos.

---

**¡Felicidades!** 🎉 Ya entiendes repaso: guards, un concepto clave en Angular.
