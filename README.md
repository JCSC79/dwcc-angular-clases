# 📘 T05E15-ngFor - ngFor - Renderizado de Listas

## 🎯 Objetivo del Ejercicio

Usar *ngFor para iterar sobre arrays y generar elementos HTML repetidos

**Tema**: Generarás listas dinámicas de elementos HTML
...
### 1. ***ngFor**
Concepto fundamental para entender ngfor - renderizado de listas.
...
Continúa con **T05E16-ngFor-v2 - ngFor Avanzado**

---

**¡Felicidades!** 🎉 Ya entiendes ngfor - renderizado de listas, un concepto clave en Angular.
