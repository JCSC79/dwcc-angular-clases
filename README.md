...
Escuchar eventos del host Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| @HostListener | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | HostListener | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=hostlistener+en+español)
