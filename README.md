...
Manejo de plural/singular Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| [ngPlural] | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | NgPlural | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=ngplural+en+español)
