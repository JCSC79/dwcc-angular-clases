...
Componentes comunican datos Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| @Input | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | Input & Output | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=input+&+output+en+español)
