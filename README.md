# 📘 T06E34-probas-http - Pruebas HTTP
...
### Concepto Principal
Este ejercicio enseña los fundamentos y buenas prácticas de pruebas http.
...
```bash
# 1. Cambiar a la rama
git checkout T06E34-probas-http
...
Continúa con **Repaso-Repaso-Comunicacion-Componhentes** para profundizar en los conceptos.

---

**¡Felicidades!** 🎉 Ya entiendes pruebas http, un concepto clave en Angular.
