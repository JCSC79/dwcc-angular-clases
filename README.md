# 📘 T06E33-probas-crud - Pruebas de CRUD
...
### Concepto Principal
Este ejercicio enseña los fundamentos y buenas prácticas de pruebas de crud.
...
```bash
# 1. Cambiar a la rama
git checkout T06E33-probas-crud
...
Continúa con **T06E34-probas-http** para profundizar en los conceptos.

---

**¡Felicidades!** 🎉 Ya entiendes pruebas de crud, un concepto clave en Angular.
