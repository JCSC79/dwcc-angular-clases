# 📘 T06E19-http-client - HttpClient Básico

## 🎯 Objetivo del Ejercicio

Hacer peticiones HTTP GET, POST, PUT, DELETE

**Tema**: Comunincairas con servidores via HTTP
...
### 1. **HttpClient**
Concepto fundamental para entender httpclient básico.
...
```bash
# 1. Ir a la rama
git checkout T06E19-http-client
...
Continúa con **T06E20-http-client-mockapi - HttpClient con Mock API**

---

**¡Felicidades!** 🎉 Ya entiendes httpclient básico, un concepto clave en Angular.
