...
Organización de aplicación Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| @NgModule | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | NgModules | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=ngmodules+en+español)
