...
Capturar eventos del teclado Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| @HostListener('keydo | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | Keyboard Events | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=keyboard+events+en+español)
