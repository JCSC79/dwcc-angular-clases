# 📘 T06E03-modulos - Módulos (NgModules)

## 🎯 Objetivo del Ejercicio

Entender NgModules y cómo organizar componentes, directivas y servicios

**Tema**: Organizaras la aplicación con módulos
...
### 1. **@NgModule**
Concepto fundamental para entender módulos (ngmodules).
...
Continúa con **T06E04-modulos-lazy-loading - Lazy Loading de Módulos**

---

**¡Felicidades!** 🎉 Ya entiendes módulos (ngmodules), un concepto clave en Angular.
