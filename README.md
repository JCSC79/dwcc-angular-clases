...
Iterar componentes dinámicamente Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| Listas de componente | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | NgFor Components | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=ngfor+components+en+español)
