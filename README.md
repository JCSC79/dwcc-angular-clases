# 📘 Exercicios-ExercicioParametros - Ejercicio Especial: Parámetros Dinámicos

## 🎯 Objetivo del Ejercicio

Trabajar con parámetros dinámicos en rutas y componentes

**Tema**: Manejaras parámetros dinámicos avanzados
...
### 1. **Parámetros**
Concepto fundamental para entender ejercicio especial: parámetros dinámicos.
...
```bash
# 1. Ir a la rama
git checkout Exercicios-ExercicioParametros
...
Continúa con **Exercicios-Exercicio-Peliculas-Rutas - Ejercicio Especial: Películas y Rutas**

---

**¡Felicidades!** 🎉 Ya entiendes ejercicio especial: parámetros dinámicos, un concepto clave en Angular.
