# 📘 T06E13-rutas-parametros - Parámetros en Rutas

## 🎯 Objetivo del Ejercicio

Pasar parámetros dinámicos en rutas (:id)

**Tema**: Pasaras datos mediante parámetros de ruta
...
Concepto fundamental para entender parámetros en rutas.
...
```bash
# 1. Ir a la rama
git checkout T06E13-rutas-parametros
...
Continúa con **T06E14-rutas-parametros-consulta - Query Parameters**

---

**¡Felicidades!** 🎉 Ya entiendes parámetros en rutas, un concepto clave en Angular.
