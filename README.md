# 📘 Repaso-Repaso-Directivas - Repaso: Directivas

## 🎯 Objetivo del Ejercicio

Repasar ngIf, ngFor, etc.
...
### Concepto Principal
Este ejercicio enseña los fundamentos y buenas prácticas de repaso: directivas.
...
```bash
# 1. Cambiar a la rama
git checkout Repaso-Repaso-Directivas
...
Continúa con **Repaso-RepasoGuard** para profundizar en los conceptos.

---

**¡Felicidades!** 🎉 Ya entiendes repaso: directivas, un concepto clave en Angular.
