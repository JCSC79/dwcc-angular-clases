# 📘 Repaso-RepasoObservables - Repaso: Observables

## 🎯 Objetivo del Ejercicio

Repasar Observables, Subject y operadores RxJS

**Tema**: Reforzaras Observables y RxJS
...
### 1. **Observable**
Concepto fundamental para entender repaso: observables.
...
```bash
# 1. Ir a la rama
git checkout Repaso-RepasoObservables
...
Continúa con **Repaso-RepasoTeclado - Repaso: Eventos de Teclado**

---

**¡Felicidades!** 🎉 Ya entiendes repaso: observables, un concepto clave en Angular.
