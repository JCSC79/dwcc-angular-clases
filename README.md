# 📘 T06E24-control-a-medida - Controles Personalizados

## 🎯 Objetivo del Ejercicio

Crear componentes reutilizables como controles personalizados

**Tema**: Crearás controles personalizados profesionales
...
Concepto fundamental para entender controles personalizados.
...
```bash
# 1. Ir a la rama
git checkout T06E24-control-a-medida
...
Continúa con **T06E25-ciclo-vida-componhentes - Ciclo de Vida de Componentes**

---

**¡Felicidades!** 🎉 Ya entiendes controles personalizados, un concepto clave en Angular.
