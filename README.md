# 📘 T05E18-ngSwitch - ngSwitch - Renderizado Selectivo

## 🎯 Objetivo del Ejercicio

Usar *ngSwitch para mostrar diferentes contenidos basados en una condición

**Tema**: Implementarás lógica de switch-case en las plantillas
...
### 1. ***ngSwitch**
Concepto fundamental para entender ngswitch - renderizado selectivo.
...
Continúa con **T05E19-ngPlural - ngPlural - Plural Dinámico**

---

**¡Felicidades!** 🎉 Ya entiendes ngswitch - renderizado selectivo, un concepto clave en Angular.
