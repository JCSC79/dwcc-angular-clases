...
Optimizar con lazy loading Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| loadChildren | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | Route Lazy Loading | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=route+lazy+loading+en+español)
