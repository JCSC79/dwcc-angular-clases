...
Reutilizar lógica en componentes Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| @Component | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | Components Intro | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=components+intro+en+español)
