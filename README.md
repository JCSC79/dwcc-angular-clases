...
Bindings a nivel del elemento host Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| @HostBinding | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | HostBinding | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=hostbinding+en+español)
