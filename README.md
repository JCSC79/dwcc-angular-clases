# 📘 T06E25-ciclo-vida-componhentes - Ciclo de Vida de Componentes

## 🎯 Objetivo del Ejercicio

Entender e implementar hooks del ciclo de vida (OnInit, OnDestroy, etc.)

**Tema**: Controlaras el ciclo de vida de componentes
...
### 1. **Lifecycle hooks**
Concepto fundamental para entender ciclo de vida de componentes.
...
```bash
# 1. Ir a la rama
git checkout T06E25-ciclo-vida-componhentes
...
Continúa con **T06E26-pipes - Pipes Integrados**

---

**¡Felicidades!** 🎉 Ya entiendes ciclo de vida de componentes, un concepto clave en Angular.
