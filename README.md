# 📘 T06E31-formulario-ficheiro - Subida de Archivos

## 🎯 Objetivo del Ejercicio

File upload en formularios
...
### Concepto Principal
Este ejercicio enseña los fundamentos y buenas prácticas de subida de archivos.
...
```bash
# 1. Cambiar a la rama
git checkout T06E31-formulario-ficheiro
...
Continúa con **T06E32-probas-unitarias** para profundizar en los conceptos.

---

**¡Felicidades!** 🎉 Ya entiendes subida de archivos, un concepto clave en Angular.
