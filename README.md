...
Organizar interfaz con componentes Este concepto es fundamental porque:
...
|----------|----------|---------|-----------|
| Composición de compo | Ver código | app.component.ts | Mirar el src/ |
| Patrón | Estructura | Component Layout | Practicar |
...
- [YouTube - Tutoriales Angular en Español](https://www.youtube.com/results?search_query=component+layout+en+español)
